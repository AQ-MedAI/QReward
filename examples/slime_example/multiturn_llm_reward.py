...
class RewardMultiturn:
    ...
    async def calculate_rewards(self, messages: List[Dict[str, str]]):
        score_resp = await self.generative_reward_r1(messages)
        # maybe have some score calculate logic or multi reward function here.
        return score_resp
